...
public sealed class InMemoryEnterprisePlatformService : IEnterprisePlatformService
{
    ...
    private static Dictionary<string, FormulaDefinitionDto> BuildDefaultFormulas()
    {
        ...
        return new Dictionary<string, FormulaDefinitionDto>(StringComparer.OrdinalIgnoreCase)
        {
            ["power_on_rate"] = new()
            {
                Code = DefaultFormulaCatalog.PowerOnRateCode,
                DisplayName = DefaultFormulaCatalog.PowerOnRateDisplayName,
                Description = DefaultFormulaCatalog.PowerOnRateDescription,
                Expression = DefaultFormulaCatalog.PowerOnRateExpression,
                PrimaryVariable = DefaultFormulaCatalog.DefaultPowerOnVariable,
                StandardWorkHours = DefaultFormulaCatalog.DefaultStandardWorkHours,
                Coefficient = DefaultFormulaCatalog.DefaultCoefficient,
                VisibleOptions = DefaultFormulaCatalog.BaseVisibleOptions.ToArray(),
                ResultUnit = "%",
                UpdatedAt = now,
                UpdatedBy = "system",
            },
            ...
            {
                Code = DefaultFormulaCatalog.UtilizationRateCode,
                DisplayName = DefaultFormulaCatalog.UtilizationRateDisplayName,
                Description = DefaultFormulaCatalog.UtilizationRateDescription,
                Expression = DefaultFormulaCatalog.UtilizationRateExpression,
                PrimaryVariable = DefaultFormulaCatalog.DefaultUtilizationVariable,
                StandardWorkHours = DefaultFormulaCatalog.DefaultStandardWorkHours,
                Coefficient = DefaultFormulaCatalog.DefaultCoefficient,
                VisibleOptions = DefaultFormulaCatalog.BaseVisibleOptions.ToArray(),
                ResultUnit = "%",
    ...
    private static FormulaDefinitionDto CloneFormula(FormulaDefinitionDto source)
    {
        return new FormulaDefinitionDto
        {
            ...
            VisibleOptions = source.VisibleOptions.ToArray(),
